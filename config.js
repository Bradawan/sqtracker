...
module.exports = {
  envs: {
    ...
    SQ_SITE_NAME: "Brads Moe Torrents",

    // A short description of your tracker site. Maximum 80 characters.
    SQ_SITE_DESCRIPTION: "Ethical Torrenting",
    ...
    SQ_TORRENT_CATEGORIES: {
      ...
      TV: ["BluRay", "WebDL", "HDRip", "WebRip", "DVD", "Cam"],
      Anime: ["BluRay", "WebDL", "HDRip", "WebRip", "DVD", "Cam"],
      Music: ["good", "bad"],
      Books: ["Action and Adventure", "Classic", "Comic and Graphic Novel", "Crime and Detective", "Drama", "Fable", "Fairy Tale", "Fantasy", "Historical Fiction", "Horror", "Humor", "Legend", "Mystery", "Mythology", "Realistic Fiction", "Romance", "Science Fiction", "Short Story", "Thriller", "Biography", "Essay", "Memoir", "Narrative Nonfiction", "Speech", "Textbook", "Poetry"],
      Games: ["Action", "Adventure", "Role-Playing", "Simulation", "Strategy", "Sports", "Puzzle", "Idle", "Racing", "Fighting", "Shooter", "Platform", "Stealth", "Survival", "Battle Royale", "Music", "Horror", "MMORPG", "MOBA", "Card", "Board", "Educational", "VR", "AR", "Casual", "Indie", "Roguelike", "Metroidvania", "Visual Novel"],
      AI: ["Machine Learning", "Deep Learning", "Neural Networks", "Natural Language Processing", "Computer Vision", "Reinforcement Learning", "Supervised Learning", "Unsupervised Learning", "Semi-Supervised Learning", "Generative Adversarial Networks", "Decision Trees", "Support Vector Machines", "Bayesian Networks", "Evolutionary Computation", "Swarm Intelligence", "Robotic Process Automation", "Expert Systems", "Speech Recognition", "Image Recognition", "AI Ethics", "AI in Healthcare", "AI in Finance", "AI in Gaming", "AI in Education", "AI in Transportation", "AI in Marketing", "AI Tools and Frameworks", "AI Datasets", "AI Tutorials", "AI Papers"],
      Miscellaneous: ["Random"],
      
    },

    // Number of bonus points awarded to a user for each GB they upload. Minimum 0.
    SQ_BP_EARNED_PER_GB: 5,
